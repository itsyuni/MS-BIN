...
var Terminal = Terminal || function(cmdLineContainer, outputContainer) {
  ...
  const CMDS_ = [
    'clear', 'date', 'echo', 'aboutme', 'update', 'file', 'msbin', 'open', 'helloworld', 'musiclist', 'play_music(1...)', 'videoslist'];
      ...
      switch (cmd) {
        ...
        case 'update':
          output('Обновлений нет.');
           break;
        case 'file':
          output('tea.png'+'<p>fire.png</p>');
          break;
        case 'msbin':
          output('<h2>MS Bin</h2><p>'+'</p><p>Version 0.1 BETA</p>'+'<p>Автор:NikitaStepler</p>'+'<p>Build:1000</p>'+'<p>CatbinLabs</p>'+'<p>Версия создана 14.08.2020</p>'+'<p>End supprort: ¯\_(ツ)_/¯</p>');
          break;
        case 'open':
  ...
  return {
    init: function() {
      output('<img align="left" src="image/MSBin.jpg" width="100" height="100" style="padding: 0px 10px 20px 0px"><h2 style="letter-spacing: 4px">MS Bin</h2><p>'+'</p><p>Version 0.1 BETA</p>' + '</p><p>Напишите "help" что бы узнать все команды.</p>');
    },
    output: output
  }
};
